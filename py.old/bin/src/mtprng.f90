...
!-----------------------------------------------------------------------
    ...
    public :: mtprng_state, &
              ...
              mtprng_rand_real1, mtran, mtprng_rand_real3
    ...
    ! SHChange: PUBLIC MTSTAT (status store variable)
    type(mtprng_state), public, save :: MTSTAT
...
contains
    ...
    function mtprng_rand_range(state, lo, hi) result(r)
        ...
        r = lo + floor((hi - lo + 1.0_IEEE64) * mtran(state))
